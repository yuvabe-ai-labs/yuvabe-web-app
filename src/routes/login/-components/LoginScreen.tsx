...
export default function LoginScreen() {
  ...
  return (
    // Outer container matches RN SafeAreaView flex:1 + COLORS.background
    <div className="min-h-screen w-full bg-white sm:bg-gray-50 flex items-center justify-center font-sans">
      {/* Mobile Container Simulation 
         - On Mobile: Full width, white bg, padding 24px (SIZES.padding * 1.5)
         - On Desktop: Fixed width (400px), rounded card
      */}
      <div className="w-full h-full sm:h-auto sm:max-w-[400px] bg-white sm:rounded-3xl sm:shadow-2xl sm:border border-border flex flex-col">
        {/* ScrollView Content Container Equivalent */}
        <div className="flex-1 p-6 flex flex-col justify-center min-h-[600px]">
          {/* Logo Section */}
          <div className="w-[100px] h-[100px] mx-auto mb-6 flex items-center justify-center ">
            {/* Using text-primary (#5829c7) to color the SVG */}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="space-y-1">
              <Input
                ...
                type="email"
                placeholder="Email"
                // Matches RN: borderRadius: 12, paddingVertical: ~14px, fontSize: 14
            ...
            <div className="space-y-1">
              <div className="relative">
                <Input
                  ...
                  // Matches RN passwordContainer style
                ...
                {/* Eye Icon - Matches TouchableOpacity + Eye Color */}
                <button
                  type="button"
            ...
            <Button
              type="submit"
              // Matches RN: bg-primary, paddingVertical: 16 (h-14 approx), borderRadius: 12
